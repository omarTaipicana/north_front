...
const WHATSAPP_LINK =
    ...
    encodeURIComponent("Hola NORTH EVENTS, quiero ser auspiciante. ¿Me brindan información?");
                ...
                <section className="sponsorCompact">
                    <div className="sponsorMiniCTA">
                        ...
                        <p className="sponsorMiniCTA__text">
                            Te enviamos propuestas de visibilidad, activaciones, stands y menciones en redes.
                        </p>
                        ...
                        <form className="sponsorMiniForm" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="miniMeta">
                                {errors.nombres || errors.telefono || errors.email || errors.mensaje ? (
                                    <div className="miniError">Completa los campos requeridos.</div>
                                ) : (
                ...
                >
                    <div className="partnersModal__card">
                        ...
                        <div className="partnersModal__actions">
                            <button type="button" className="partnersModal__btn" onClick={closeModal}>
                                Entendido
                            </button>
                        </div>
                    </div>
